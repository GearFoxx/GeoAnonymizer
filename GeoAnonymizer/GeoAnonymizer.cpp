...
// GeoAnonymizer.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGeoAnonymizerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGeoAnonymizerApp

CGeoAnonymizerApp::CGeoAnonymizerApp()
{
...
// Единственный объект CGeoAnonymizerApp

CGeoAnonymizerApp theApp;


// Инициализация CGeoAnonymizerApp

BOOL CGeoAnonymizerApp::InitInstance()
{
